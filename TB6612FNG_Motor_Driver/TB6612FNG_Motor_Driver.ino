//Code to operate TB6612FNG Motor Driver
/*
...
void loop() {
  ...
  //un comment this if you want to enter motor speed values via serial monitor
  /*
   ...
   */
   ...
   // Un Comment this if you want the motor to just spin
   //motorSpeed = 255;
